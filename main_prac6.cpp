...
GLfloat ADiffuse[] = { .5, 0.5, 0.5, 1.0f };			// anillo
GLfloat ASpecular[] = { .5, 0.5, 0.5, 1.0 };
...
GLfloat UrDiffuse[] = { .62, 0.96, 0.96, 1.0f };			// urano
GLfloat UrSpecular[] = { .62, 0.8, 0.8, 1.0 };
GLfloat UrShininess[] = { 50.0 };

GLfloat NepDiffuse[] = { .25, 0.37, 0.93, 1.0f };			// Neptuno
GLfloat NepSpecular[] = { .25, 0.2, 0.8, 1.0 };
GLfloat NepShininess[] = { 50.0 };

GLfloat VDiffuse[] = { .5, 0.5, 0.5, 1.0f };			// Neptuno
GLfloat VSpecular[] = { .5, 0.2, 0.5, 1.0 };
GLfloat VShininess[] = { 50.0 };
